...
const{removeFromCart,increaseAmount, decreaseAmount}= useContext(CartContext)
  ...
  <div className='flex gap-x-4 py-2 lg:px-6 border-b  w-full font-light text-gray-500'> 
    ...
    <div className='w-full flex flex-col'>
      ...
      <div onClick={()=> removeFromCart(id)} className='text-xl cursor-pointer'><IoMdClose className='text-gray-500 hover:text-red-500 transition'  />
      </div>
      </div>
      <div className=' flex gap-x-2 h-[36px] text-sm'>
        <div className='flex flex-1 max-w-[100px]  items-center h-full border text-primary font-medium border-gray-400'>
